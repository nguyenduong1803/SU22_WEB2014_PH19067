...
if (isset($_GET['listId']) && isset($_GET['q']) && isset($_GET['phone'])) {
    ...
    $listId = $_GET['listId'];
    echo $today;
    $sqlID = "SELECT maHoaDon FROM `hoadon` WHERE maKh='$userId'  and soDienThoai ='{$phone}' and uniqId ='{$uniq}' LIMIT 1;";
    ...
    foreach ($products as $key => $value) {
        ...
        echo $productId.'<br>';
        $removeCookie =array_search($value['maHangHoa'],$getCookie);
        array_splice($getCookie,$removeCookie,1);
    }
